...
public class Main extends Thread{
    public static void main(String[] args) {
        ...
        for (double i = 0.0; i< 4.0; i++) {
            ...
            if (i == 1.0) {
                threadList.add(new SortedLinkedListV2_Runnable_Course_Grain(listV2,11,16,"Adaugare"));
            }
            if (i == 2.0) {
                threadList.add(new SortedLinkedListV2_Runnable_Course_Grain(listV2,0,6,"Stergere")); // aici trebuie sa ne asiguram ca valoarea ce urmeaza a fi stearsa exista in lista
            }
              if (i == 3.0) {
